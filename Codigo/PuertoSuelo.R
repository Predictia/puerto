...
prof<-raster("./CantabriaSuelos/Profundidad.tif")
...
text<-raster("./CantabriaSuelos/Textura.tif")
...
D1b<-data.table(IDMancha=c(tesed50@data$ID_Mancha),
...
save(D1b,file=paste0("./Inputs/sites/",site,"/suelo.Rdata"))
