...
VPhift<-T4[FA4][,list(IDRebaño,Especie,PMtot,UP,IDMancha,com,com2,IDHL,IDHL2,sup,
...
DIASht0<-unique(VPhift[,.(IDRebaño)]);setkey(DIASht0,IDRebaño)
setkey(VPhift,IDRebaño,com2,Fantin,prcom1,corhft)
DIAShft0<-unique(VPhift[,.(IDRebaño,com2,Fantin,prcom1,corhft)])
setkey(DIAShft0,corhft)
DIASht1<-DIAShft0[!J(1)][,.(menFantin=1-sum(Fantin)),keyby=.(IDRebaño)]
DIASht2<-DIAShft0[J(1)][,.(prcom2=sum(prcom1)),keyby=.(IDRebaño)]
DIASht3<-DIASht2[DIASht1[DIASht0]][,.(IDRebaño,prcom3=ifelse(prcom2==0,0,
...
setkey(pl1$A0b,t)
A0bt<-pl1$A0b[.(tt)]
setkey(A1t20,IDRebaño,Raza,Categoria,t,diay)
setkey(A0bt,IDRebaño,Raza,Categoria,t,diay)
...
CIRhift02<-pl1$A4[CIRhift01][,msu:=biovta+biomta][,
    ch:=Tri(msu,linf,lsup,0,1)][,cirhift02:=ifelse(cirhift01<=ch,cirhift01,ch)][,
        mxcir2:=ifelse(ch<1,0,ifelse(cirhift02==Fantin,0,1))][,
          list(IDRebaño,t,UP,IDMancha,com,com2,ch,Fantin,cirhift02,mxcir2,
